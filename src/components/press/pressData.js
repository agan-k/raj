...
const pressData = [
...

   {
      ...
      contemporary jazz, then “Galadari” and “Hirimbura” grounds us a bit more, showing that the group is capable of muscling up when the music calls for it. The former number denotes bold shifts in tempo and has Cheek and Stuckey trading bars with keenness; the latter piece, on the other hand, swings uncompromisingly with hard-bop ardor, stepping into more familiar territory.
   ...
   },
   {
      ...
      today.`, 
      body1: `The album is bookended by two different versions of the title track, Pistils. The 
      ...
      body2: `"Ellstandissa", featuring the relatively unknown Thammattama drum (also known as a temple drum), 
      ...
      body3: `It’s fitting that the next track is "Welikadawatte", translating to Welikada Gardens in Sinhalese. 
     ...
     body4: `Hirimbura is Rajiv’s Grandfather’s hometown in the south of Sri Lanka. The piece has ‘stompy’ 
   ...
   },
   {
      ...
      body1: `From the tough and intrepid ‘Intro’, ‘Datameta’ slowly divulges into an epic anthem. 
      ...
      body2: `Carl Morgan is a guitarist-composer from Sydney, currently based in Berlin. Winner of 
      ...
      body3: `Rajiv Jayaweera is a highly sought-after drummer, having toured and recorded with some of 
      ...
      body4: `Sam Anning is a major force in Australian jazz, being a prolific recording artist and 

...
const home_cardsData = [
   {
      ...
      img: modern_drummer,
      date: 'October, 2020',
      card_subject: 'Interview with Modern Drummer',
      card_blurb: `It’s atypical for a drummer-led debut to open with a contemplative, rubato tune shaded by hushed, 
      minimal brushwork. But jazz drummer/composer Rajiv Jayaweera favors attention to sound and ensemble voice
      over bluster. On Pistils (Outside in Music), Jayaweera’s superb touch yields dancing interplay and dramatic dynamics, 
      calling..`,
      link: true,
      press_link: '15'
   },
